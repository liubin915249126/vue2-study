      ...
      <div class="len-content-left">
        ...
        >
          ...
          <el-submenu index="1">
            ...
            <el-menu-item-group title="其他">
              <el-menu-item index="0-1"
                ><router-link to="/main/about/123"
                  >about</router-link
                ></el-menu-item
              >
              <el-menu-item index="0-2"
                ><router-link to="/main/about/123/child"
                  >child router</router-link
                ></el-menu-item
              >
              <el-menu-item index="0-3"
                ><router-link to="/main/a">redirect</router-link></el-menu-item
              >
              <el-menu-item index="0-4"
                ><router-link to="/main/count">count</router-link></el-menu-item
              >
              <el-menu-item index="0-5"
                ><router-link to="/main/component"
          ...
          <el-submenu index="2">
            ...
            <el-menu-item-group title="配置页面">
              <el-menu-item index="2-1"
                ><router-link to="/main/apiconfig"
                  >apiconfig</router-link
                ></el-menu-item
              >
            </el-menu-item-group>
          </el-submenu>
          <el-submenu index="3">
            ...
            <el-menu-item index="2-1"
              ><router-link to="/main/draw">画笔</router-link></el-menu-item
            >
          </el-submenu>
        </el-menu>
      </div>
